...
def get_viastat_offer_data(unit: str, street: str, city: str, state: str, zip_code: str, lat: float, lon: float):
    ...
    'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmbG93SWQiOiI3Y2ZmNmFmNi0wMGRlLTQ4NmUtOWJiNi1iYzFjMzI1NmZlYTMiLCJsYW5ndWFnZSI6ImVuIiwiY291bnRyeSI6IlVTIiwiZW52IjoicHJvZCIsImN1c3RvbWVyVHlwZSI6InJlc2lkZW50aWFsIiwiaWF0IjoxNzAxODAxMDc2LCJleHAiOjE3MDE4MDQ2NzZ9.mgdI9NmLL6-BmQHi9TkFthXQPvTNtlJqy4Fm5wuF5-Q',
