...
def get_viastat_offer_data(unit: str, street: str, city: str, state: str, zip_code: str, lat: float, lon: float):
    ...
    'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmbG93SWQiOiJhN2U3OWIwOC00YTZmLTRiN2QtYmI0NS0yM2Y4NTNmN2EwNjIiLCJsYW5ndWFnZSI6ImVuIiwiY291bnRyeSI6IlVTIiwiZW52IjoicHJvZCIsImN1c3RvbWVyVHlwZSI6InJlc2lkZW50aWFsIiwiaWF0IjoxNzAxNjU1NTIxLCJleHAiOjE3MDE2NTkxMjF9.bZphSx5r3ipXicpJpdbdlxP0xxu25Gj76zBUMhqOtRk',
