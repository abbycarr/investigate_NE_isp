...
def get_viastat_offer_data(unit: str, street: str, city: str, state: str, zip_code: str, lat: float, lon: float):
    ...
    'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmbG93SWQiOiI0MTM3MTAxMi0xMWUxLTQ3OWYtODMyMy04YmQxZTJiMGJkMDYiLCJsYW5ndWFnZSI6ImVuIiwiY291bnRyeSI6IlVTIiwiZW52IjoicHJvZCIsImN1c3RvbWVyVHlwZSI6InJlc2lkZW50aWFsIiwiaWF0IjoxNzAxNzE3MDQ0LCJleHAiOjE3MDE3MjA2NDR9.I4wrNeZGCEcC31QeIOccbmyVulPwU3s1SKgbB-URE8o',
