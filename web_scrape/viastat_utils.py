...
def get_viastat_offer_data(unit: str, street: str, city: str, state: str, zip_code: str, lat: float, lon: float):
    ...
    'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmbG93SWQiOiI4NDdkMDNkZS1kNzc4LTQxMWQtOWY4Yi1mNjMzMTc3OTU1NTIiLCJsYW5ndWFnZSI6ImVuIiwiY291bnRyeSI6IlVTIiwiZW52IjoicHJvZCIsImN1c3RvbWVyVHlwZSI6InJlc2lkZW50aWFsIiwiaWF0IjoxNzAxODE5NTA3LCJleHAiOjE3MDE4MjMxMDd9.x70SsLZHKUxI3njFtVHYfLZe5CqXGuctn5rqi6_TSxQ',
