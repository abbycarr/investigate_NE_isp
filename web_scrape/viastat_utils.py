...
def get_viastat_offer_data(unit: str, street: str, city: str, state: str, zip_code: str, lat: float, lon: float):
    ...
    'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmbG93SWQiOiIzNjc3ZGZhZS1lZjFlLTRhMWMtYmM2NC0yZDNhMjI3YWUyMmMiLCJsYW5ndWFnZSI6ImVuIiwiY291bnRyeSI6IlVTIiwiZW52IjoicHJvZCIsImN1c3RvbWVyVHlwZSI6InJlc2lkZW50aWFsIiwiaWF0IjoxNzAxODE4MzI0LCJleHAiOjE3MDE4MjE5MjR9.KTYYmasfPexjcdF3E3sxTBO0KkhS3ddsqFEPWir_BAY',
